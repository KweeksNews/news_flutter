...
import 'package:kweeksnews_app/core/data/database/app_database.dart' as _i3;
...
import 'core/presentation/router/app_router.dart' as _i69;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i7.GlobalKey<_i9.FeaturedContentState>>(
    ...
    gh.lazySingleton<_i7.GlobalKey<_i10.SavedPostsPageState>>(
    ...
    gh.lazySingleton<_i12.GraphQLClient>(() => appInjection.gqlClient(
    ...
    gh.lazySingleton<_i4.QueryExecutor>(() => appInjection.queryExecutor);
    ...
    gh.lazySingleton<_i42.GetPosts>(
        () => _i42.GetPosts(gh<_i19.HomeRepository>()));
    gh.lazySingleton<_i43.GetPosts>(
        () => _i43.GetPosts(gh<_i34.SingleUserRepository>()));
    gh.lazySingleton<_i44.GetPosts>(
        () => _i44.GetPosts(gh<_i32.SingleTagRepository>()));
    gh.lazySingleton<_i45.GetPosts>(
        () => _i45.GetPosts(gh<_i28.SingleCategoryRepository>()));
    ...
    gh.factory<_i54.SavedPostNotifier>(() => _i54.SavedPostNotifier(
          ...
          gh<_i7.GlobalKey<_i10.SavedPostsPageState>>(
              instanceName: 'savedPostsPageKey'),
        ));
    ...
    gh.factory<_i62.TagPostsNotifier>(
        () => _i62.TagPostsNotifier(gh<_i44.GetPosts>()));
    ...
    gh.factory<_i64.UserPostsNotifier>(
        () => _i64.UserPostsNotifier(gh<_i43.GetPosts>()));
    gh.factory<_i65.CategoryPostsNotifier>(
        () => _i65.CategoryPostsNotifier(gh<_i45.GetPosts>()));
    ...
    gh.factory<_i66.FeaturedContentNotifier>(
        () => _i66.FeaturedContentNotifier(gh<_i42.GetPosts>()));
...
class _$AppInjection extends _i68.AppInjection {}
