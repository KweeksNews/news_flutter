...
import 'features/home/presentation/notifier/home_notifier.dart' as _i32;
...
import 'features/settings/domain/usecases/set_locale.dart' as _i37;
import 'features/settings/domain/usecases/set_theme.dart' as _i38;
import 'features/settings/presentation/notifier/locale_notifier.dart' as _i41;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i32.HomeNotifier, String, dynamic>(
      (_categoryId, _) => _i32.HomeNotifier(get<_i29.GetPosts>(), _categoryId));
  gh.lazySingleton<_i33.IsSavedPost>(
      () => _i33.IsSavedPost(get<_i23.SinglePostRepository>()));
  gh.factory<_i34.RelatedPostsNotifier>(
      () => _i34.RelatedPostsNotifier(get<_i30.GetRelatedPosts>()));
  gh.factory<_i35.SavedPostNotifier>(() => _i35.SavedPostNotifier(
      get<_i25.CreateSavedPost>(),
      get<_i26.DeleteSavedPost>(),
      get<_i33.IsSavedPost>()));
  gh.lazySingleton<_i36.SearchPosts>(
      () => _i36.SearchPosts(get<_i19.SearchRepository>()));
  gh.lazySingleton<_i37.SetLocale>(
      () => _i37.SetLocale(get<_i21.SettingsRepository>()));
  gh.lazySingleton<_i38.SetTheme>(
      () => _i38.SetTheme(get<_i21.SettingsRepository>()));
  gh.factory<_i39.SinglePostNotifier>(
      () => _i39.SinglePostNotifier(get<_i28.GetPost>()));
  gh.factory<_i40.ThemeNotifier>(
      () => _i40.ThemeNotifier(get<_i31.GetTheme>(), get<_i38.SetTheme>()));
  gh.factory<_i41.LocaleNotifier>(
      () => _i41.LocaleNotifier(get<_i27.GetLocale>(), get<_i37.SetLocale>()));
  gh.factory<_i12.SearchNotifier>(
      () => _i12.SearchNotifier(get<_i36.SearchPosts>()));
  return get;
}
