...
import 'features/saved_posts/domain/repositories/saved_posts_repository.dart'
    as _i17;
import 'features/saved_posts/domain/usecases/get_saved_posts.dart' as _i41;
...
import 'features/settings/domain/usecases/get_theme.dart' as _i43;
...
import 'features/single_category/domain/usecases/get_posts.dart' as _i37;
...
import 'features/single_post/domain/usecases/is_saved_post.dart' as _i45;
...
import 'features/single_tag/domain/usecases/get_tag.dart' as _i42;
...
import 'features/single_user/domain/usecases/get_user.dart' as _i44;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i37.GetPosts>(
      () => _i37.GetPosts(get<_i23.SingleCategoryRepository>()));
  gh.lazySingleton<_i38.GetPosts>(
      () => _i38.GetPosts(get<_i14.HomeRepository>()));
  ...
  gh.lazySingleton<_i41.GetSavedPosts>(
      () => _i41.GetSavedPosts(get<_i17.SavedPostsRepository>()));
  gh.lazySingleton<_i42.GetTag>(
      () => _i42.GetTag(get<_i27.SingleTagRepository>()));
  gh.lazySingleton<_i43.GetTheme>(
      () => _i43.GetTheme(get<_i21.SettingsRepository>()));
  gh.lazySingleton<_i44.GetUser>(
      () => _i44.GetUser(get<_i29.SingleUserRepository>()));
  gh.lazySingleton<_i45.IsSavedPost>(
      () => _i45.IsSavedPost(get<_i25.SinglePostRepository>()));
  gh.factory<_i46.RelatedPostsNotifier>(
      () => _i46.RelatedPostsNotifier(get<_i40.GetRelatedPosts>()));
  gh.factory<_i47.SavedPostNotifier>(() => _i47.SavedPostNotifier(
      get<_i31.CreateSavedPost>(),
      get<_i32.DeleteSavedPost>(),
      get<_i45.IsSavedPost>()));
  gh.factory<_i48.SavedPostsNotifier>(
      () => _i48.SavedPostsNotifier(get<_i41.GetSavedPosts>()));
  ...
  gh.factory<_i52.SingleCategoryNotifier>(
      () => _i52.SingleCategoryNotifier(get<_i33.GetCategory>()));
  gh.factory<_i53.SinglePostNotifier>(
      () => _i53.SinglePostNotifier(get<_i35.GetPost>()));
  gh.factory<_i54.SingleTagNotifier>(
      () => _i54.SingleTagNotifier(get<_i42.GetTag>()));
  gh.factory<_i55.SingleUserNotifier>(
      () => _i55.SingleUserNotifier(get<_i44.GetUser>()));
  gh.factory<_i56.TagPostsNotifier>(
      () => _i56.TagPostsNotifier(get<_i39.GetPosts>()));
  gh.factory<_i57.ThemeNotifier>(
      () => _i57.ThemeNotifier(get<_i43.GetTheme>(), get<_i51.SetTheme>()));
  gh.factory<_i58.UserPostsNotifier>(
      () => _i58.UserPostsNotifier(get<_i36.GetPosts>()));
  gh.factory<_i59.CategoryPostsNotifier>(
      () => _i59.CategoryPostsNotifier(get<_i37.GetPosts>()));
  gh.factory<_i60.ContentGroupNotifier>(
      () => _i60.ContentGroupNotifier(get<_i38.GetPosts>()));
  gh.factory<_i61.FeaturedContentNotifier>(
      () => _i61.FeaturedContentNotifier(get<_i38.GetPosts>()));
  gh.factory<_i62.LocaleNotifier>(
      () => _i62.LocaleNotifier(get<_i34.GetLocale>(), get<_i50.SetLocale>()));
