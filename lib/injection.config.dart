...
import 'core/databases/databases.dart' as _i3;
import 'core/datasources/saved_posts_local_data_source.dart' as _i11;
...
import 'features/single_post/domain/usecases/is_saved_post.dart' as _i46;
...
import 'features/single_tag/domain/repositories/single_tag_repository.dart'
    as _i29;
import 'features/single_tag/domain/usecases/get_posts.dart' as _i41;
...
import 'features/single_user/domain/repositories/single_user_repository.dart'
    as _i31;
import 'features/single_user/domain/usecases/get_posts.dart' as _i38;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i3.AppDatabase>(() => _i3.AppDatabase(get<dynamic>()));
  ...
  gh.lazySingleton<_i11.SavedPostsLocalDataSource>(
      () => _i11.SavedPostsLocalDataSource(get<_i3.AppDatabase>()));
  gh.lazySingleton<_i12.SavedPostsRepository>(() =>
      _i13.SavedPostsRepositoryImpl(get<_i11.SavedPostsLocalDataSource>()));
  ...
  gh.factory<_i20.SavedPostsNotifier>(
      () => _i20.SavedPostsNotifier(get<_i17.GetSavedPosts>()));
  gh.lazySingleton<_i21.SearchRepository>(
      () => _i22.SearchRepositoryImpl(get<_i16.WpRemoteDataSource>()));
  gh.lazySingleton<_i23.SettingsRepository>(() => _i24.SettingsRepositoryImpl(
      get<_i15.ThemeLocalDataSource>(), get<_i9.LocaleLocalDataSource>()));
  gh.lazySingleton<_i25.SingleCategoryRepository>(
      () => _i26.SingleCategoryRepositoryImpl(get<_i16.WpRemoteDataSource>()));
  gh.lazySingleton<_i27.SinglePostRepository>(() =>
      _i28.SinglePostRepositoryImpl(get<_i11.SavedPostsLocalDataSource>(),
          get<_i16.WpRemoteDataSource>()));
  gh.lazySingleton<_i29.SingleTagRepository>(
      () => _i30.SingleTagRepositoryImpl(get<_i16.WpRemoteDataSource>()));
  gh.lazySingleton<_i31.SingleUserRepository>(
      () => _i32.SingleUserRepositoryImpl(get<_i16.WpRemoteDataSource>()));
  gh.lazySingleton<_i33.CreateSavedPost>(
      () => _i33.CreateSavedPost(get<_i27.SinglePostRepository>()));
  gh.lazySingleton<_i34.DeleteSavedPost>(
      () => _i34.DeleteSavedPost(get<_i27.SinglePostRepository>()));
  gh.lazySingleton<_i35.GetCategory>(
      () => _i35.GetCategory(get<_i25.SingleCategoryRepository>()));
  gh.lazySingleton<_i36.GetLocale>(
      () => _i36.GetLocale(get<_i23.SettingsRepository>()));
  gh.lazySingleton<_i37.GetPost>(
      () => _i37.GetPost(get<_i27.SinglePostRepository>()));
  gh.lazySingleton<_i38.GetPosts>(
      () => _i38.GetPosts(get<_i31.SingleUserRepository>()));
  gh.lazySingleton<_i39.GetPosts>(
      () => _i39.GetPosts(get<_i25.SingleCategoryRepository>()));
  gh.lazySingleton<_i40.GetPosts>(
      () => _i40.GetPosts(get<_i18.HomeRepository>()));
  gh.lazySingleton<_i41.GetPosts>(
      () => _i41.GetPosts(get<_i29.SingleTagRepository>()));
  gh.lazySingleton<_i42.GetRelatedPosts>(
      () => _i42.GetRelatedPosts(get<_i27.SinglePostRepository>()));
  gh.lazySingleton<_i43.GetTag>(
      () => _i43.GetTag(get<_i29.SingleTagRepository>()));
  gh.lazySingleton<_i44.GetTheme>(
      () => _i44.GetTheme(get<_i23.SettingsRepository>()));
  gh.lazySingleton<_i45.GetUser>(
      () => _i45.GetUser(get<_i31.SingleUserRepository>()));
  gh.lazySingleton<_i46.IsSavedPost>(
      () => _i46.IsSavedPost(get<_i27.SinglePostRepository>()));
  ...
  gh.factory<_i48.SavedPostNotifier>(() => _i48.SavedPostNotifier(
      ...
      get<_i46.IsSavedPost>()));
  gh.lazySingleton<_i49.SearchPosts>(
      () => _i49.SearchPosts(get<_i21.SearchRepository>()));
  gh.lazySingleton<_i50.SetLocale>(
      () => _i50.SetLocale(get<_i23.SettingsRepository>()));
  gh.lazySingleton<_i51.SetTheme>(
      () => _i51.SetTheme(get<_i23.SettingsRepository>()));
  gh.factory<_i52.SingleCategoryNotifier>(
      () => _i52.SingleCategoryNotifier(get<_i35.GetCategory>()));
  gh.factory<_i53.SinglePostNotifier>(
      () => _i53.SinglePostNotifier(get<_i37.GetPost>()));
  ...
  gh.factory<_i56.TagPostsNotifier>(
      () => _i56.TagPostsNotifier(get<_i41.GetPosts>()));
  gh.factory<_i57.ThemeNotifier>(
      () => _i57.ThemeNotifier(get<_i44.GetTheme>(), get<_i51.SetTheme>()));
  gh.factory<_i58.UserPostsNotifier>(
      () => _i58.UserPostsNotifier(get<_i38.GetPosts>()));
  gh.factory<_i59.CategoryPostsNotifier>(
      () => _i59.CategoryPostsNotifier(get<_i39.GetPosts>()));
  gh.factory<_i60.ContentGroupNotifier>(
      () => _i60.ContentGroupNotifier(get<_i40.GetPosts>()));
  gh.factory<_i61.FeaturedContentNotifier>(
      () => _i61.FeaturedContentNotifier(get<_i40.GetPosts>()));
  gh.factory<_i62.LocaleNotifier>(
      () => _i62.LocaleNotifier(get<_i36.GetLocale>(), get<_i50.SetLocale>()));
  gh.factoryParam<_i14.SearchNotifier, _i63.Reader, dynamic>(
      (_read, _) => _i14.SearchNotifier(get<_i49.SearchPosts>(), _read));
  return get;
}
