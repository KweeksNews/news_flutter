          ...
          ClipRRect(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                onTap: () {
                  context.read(themeStateProvider).setThemeState('light');
          ...
          ClipRRect(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                highlightColor: Theme.of(context).cardTheme.shadowColor,
                onTap: () {
                  context.read(themeStateProvider).setThemeState('dark');
                  Navigator.of(context).pop();
                },
                child: ListTile(
                  contentPadding: const EdgeInsets.only(left: 15),
          ...
          ClipRRect(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                highlightColor: Theme.of(context).cardTheme.shadowColor,
                onTap: () {
                  context.read(themeStateProvider).setThemeState('system');
                  Navigator.of(context).pop();
                },
                child: ListTile(
                  contentPadding: const EdgeInsets.only(left: 15),
