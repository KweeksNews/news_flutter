...
class CategoryPosts extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CategoryPosts> createState() => _CategoryPosts();
}

class _CategoryPosts extends ConsumerState<CategoryPosts>
  ...
  Widget build(
    ...
    ref.listen<CategoryPostsState>(
      ...
      (previousState, newState) {
        if (newState is CategoryPostsAppend) {
          _pagingController.appendPage(newState.posts, newState.nextPageKey);
        } else if (newState is CategoryPostsAppendLast) {
          _pagingController.appendLastPage(newState.posts);
        } else if (newState is CategoryPostsException) {
