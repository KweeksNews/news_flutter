...
import '../../domain/repositories/single_tag_repository.dart';

@LazySingleton(as: SingleTagRepository)
class SingleTagRepositoryImpl implements SingleTagRepository {
  final WpRemoteDataSource _wpRemoteDataSource;

  SingleTagRepositoryImpl(
